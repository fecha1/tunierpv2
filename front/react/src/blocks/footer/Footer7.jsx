...
const usefullLinks = [
  {
    icon: <SvgIcon name="tabler-dashboard" {...iconProps} />,
  ...
  {
    icon: <SvgIcon name="tabler-headset" {...iconProps} />,
  ...
  const logoFollowContent = (
    <Stack sx={{ alignItems: 'flex-start', gap: { xs: 1.5, sm: 3 } }}>
      ...
      <Typography variant="body2" sx={{ maxWidth: { sm: 280 } }}>
        La plateforme ERP modulaire conçue pour les entreprises tunisiennes.
      </Typography>
    </Stack>
  );
