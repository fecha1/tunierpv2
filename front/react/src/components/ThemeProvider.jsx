...
import tunierpTheme from '@/views/landings/ai/theme';

// Theme Map
const themeMap = {
  [Themes.THEME_TUNIERP]: tunierpTheme
};
...
export default function ThemeProvider({ children }) {
  ...
  const selectedTheme = themeMap[state.currentTheme]?.('data-color-scheme') || tunierpTheme('data-color-scheme');
