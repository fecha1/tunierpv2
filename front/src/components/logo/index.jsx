...
export default function LogoSection({ isIcon, sx, to }) {
  ...
  return (
    <NextLink href={!to ? process.env.NEXT_PUBLIC_BASE_NAME || '/' : to} passHref style={{ textDecoration: 'none' }}>
      <ButtonBase
        disableRipple
        sx={{ ...sx, display: 'block', textDecoration: 'none', '&:focus-visible': generateFocusVisibleStyles(palette.primary.main) }}
        aria-label="logo"
      >
